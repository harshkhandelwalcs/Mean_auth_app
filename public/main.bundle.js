...
module.exports = "<h2 class=\"page-header text-center\">Login</h2>\n<form (submit)=\"onLoginSubmit()\" #loginForm=\"ngForm\">\n    <div class=\"form-group\">\n        <label class=\"required-mark\">Username</label>\n        <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" minlength=\"5\" maxlength=\"15\" required class=\"form-control\" #usernameRef=\"ngModel\">\n        <div *ngIf=\"usernameRef.errors && (usernameRef.dirty || usernameRef.touched)\" class=\"alert alert-danger\">\n            <div [hidden]=\"!usernameRef.errors.required\">\n                Username is required!\n            </div>\n            <div [hidden]=\"!usernameRef.errors.minlength\">\n                Please use a valid username.\n            </div>\n            <div [hidden]=\"!usernameRef.errors.maxlength\">\n                Please use a valid username.\n            </div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"required-mark\">Password</label>\n        <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" minlength=\"8\" maxlength=\"16\" required class=\"form-control\"\n            #passwordRef=\"ngModel\">\n        <div *ngIf=\"passwordRef.errors && (passwordRef.dirty || passwordRef.touched)\" class=\"alert alert-danger\">\n            <div [hidden]=\"!passwordRef.errors.required\">\n                Paasword is required!\n            </div>\n            <div [hidden]=\"!passwordRef.errors.minlength\">\n                Please use a valid password.\n            </div>\n            <div [hidden]=\"!passwordRef.errors.maxlength\">\n                Please use a valid password.\n            </div>\n        </div>\n    </div>\n    <input [disabled]=\"finished\" [disabled]=\"!loginForm.form.valid\" type=\"submit\" class=\"btn btn-primary\" value=\"submit\">\n</form>"
...
module.exports = "<h2 class=\"page-header text-center\">Register</h2>\n<form (submit)=\"onRegisterSubmit()\" #registerForm=\"ngForm\">\n    <div class=\"form-group\">\n        <label class=\"required-mark\">Name</label>\n        <input type=\"text\" [(ngModel)]=\"name\" name=\"name\" minlength=\"6\" maxlength=\"15\" required class=\"form-control\" #nameRef=\"ngModel\">\n        <div *ngIf=\"nameRef.errors && (nameRef.dirty || nameRef.touched)\" class=\"alert alert-danger\">\n            <div [hidden]=\"!nameRef.errors.required\">\n                Name title is required!\n            </div>\n            <div [hidden]=\"!nameRef.errors.minlength\">\n                Name must be at least 6 characters long.\n            </div>\n            <div [hidden]=\"!nameRef.errors.maxlength\">\n                Name must be only 15 characters long.\n            </div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"required-mark\">Username</label>\n        <input type=\"text\" [(ngModel)]=\"username\" name=\"username\" minlength=\"5\" maxlength=\"15\" required class=\"form-control\" #usernameRef=\"ngModel\">\n        <div *ngIf=\"usernameRef.errors && (usernameRef.dirty || usernameRef.touched)\" class=\"alert alert-danger\">\n            <div [hidden]=\"!usernameRef.errors.required\">\n                Username  is required!\n            </div>\n            <div [hidden]=\"!usernameRef.errors.minlength\">\n                Username must be at least 5 characters long.\n            </div>\n            <div [hidden]=\"!usernameRef.errors.maxlength\">\n                Username must be only 15 characters long.\n            </div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"required-mark\">Email</label>\n        <input type=\"text\" [(ngModel)]=\"email\" name=\"email\" required class=\"form-control\" #emailRef=\"ngModel\">\n        <div *ngIf=\"usernameRef.errors && (usernameRef.dirty || usernameRef.touched)\" class=\"alert alert-danger\">\n            <div *ngIf=\"emailRef.errors && (emailRef.dirty || emailRef.touched)\">\n                <div [hidden]=\"!emailRef.errors.required\" class=\"alert alert-danger\">\n                    Enter email id\n                </div>\n                <div [hidden]=\"!emailRef.errors.pattern\" class=\"alert alert-danger\">\n                    Please enter a valid email id\n                </div>\n            </div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <label class=\"required-mark\">Password</label>\n        <input type=\"password\" [(ngModel)]=\"password\" name=\"password\" minlength=\"8\" maxlength=\"16\" required class=\"form-control\"\n            #passwordRef=\"ngModel\">\n        <div *ngIf=\"passwordRef.errors && (passwordRef.dirty || passwordRef.touched)\" class=\"alert alert-danger\">\n            <div [hidden]=\"!passwordRef.errors.required\">\n                Paasword is required!\n            </div>\n            <div [hidden]=\"!passwordRef.errors.minlength\">\n                Password must be at least 8 characters long.\n            </div>\n            <div [hidden]=\"!passwordRef.errors.maxlength\">\n                Username must be only 16 characters long.\n            </div>\n        </div>\n    </div>\n    <div class=\"form-group\">\n        <re-captcha (captchaResponse)=\"handleCorrectCaptcha($event)\" site_key=\"6Le8NTQUAAAAAHEK1dlJR8-e0lx7SI43lbEXYi53\"></re-captcha>\n    </div>\n\n    <input [disabled]=\"finished\" [disabled]=\"!registerForm.form.valid\" type=\"submit\" class=\"btn btn-primary\" value=\"submit\">\n</form>"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_angular2_recaptcha__ = __webpack_require__("../../../../angular2-recaptcha/angular2-recaptcha.js");
...
var RegisterComponent = (function () {
    function RegisterComponent(validateService, authService, router, flashMessage) {
        ...
        this.router = router;
        this.flashMessage = flashMessage;
        this.secret = "6Le8NTQUAAAAAOSu-UeAnx4a2uCNzY485662NpOY";
        this.finished = false;
    }
    RegisterComponent.prototype.ngOnInit = function () {
    };
    RegisterComponent.prototype.handleCorrectCaptcha = function (response) {
        this.token = this.captcha.getResponse();
        var secret = this.secret;
        this.reCaptcha(this.token, secret);
    };
    RegisterComponent.prototype.reCaptcha = function (token, secret) {
        var data = new __WEBPACK_IMPORTED_MODULE_6__angular_http__["URLSearchParams"]();
        data.set('response', token);
        data.set('secret', secret);
        this.authService.getCaptchaToken(data).subscribe(function (data) {
            console.log(data);
        });
    };
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_5_angular2_recaptcha__["ReCaptchaComponent"]),
...
var AuthService = (function () {
    ...
    AuthService.prototype.getCaptchaToken = function (data) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateCaptcha = function (token, secret) {
        if (token == null) {
            return false;
        }
        else {
